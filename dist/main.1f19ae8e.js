...
var CONTRACT_NAME = undefined || 'rabeb546.testnet';
/* TODO: fill this in! */
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("C:\\Users\\asus", "/.near/validator_key.json"),
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return near.loadContract(nearConfig.contractName, {
              ...
              changeMethods: ['init', 'transfer', 'approve', 'transferFrom', 'vote', 'historique'],
...
document.querySelector('.vote .btn').addEventListener('click', function () {
  contract.vote({
    tokenOwner: window.walletAccount.getAccountId()
  });
});
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return contract.historique();

          case 2:
            ch = _context2.sent;
            document.getElementById('historique').innerHTML = ch;
...
document.querySelector('.historique .btn').addEventListener('click', function () {
  write();
});
