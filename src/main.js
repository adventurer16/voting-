...
document.querySelector('.vote .btn').addEventListener('click', () => {
  contract.vote({tokenOwner:window.walletAccount.getAccountId()});
...
async function write(){
  var ch=await contract.historique();
  document.getElementById('historique').innerHTML = ch;
  return ch;}
document.querySelector('.historique .btn').addEventListener('click', () => {
  write();
});
